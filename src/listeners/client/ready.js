...
module.exports = class Ready extends Event {
	...
	async run() {
		...
		if (this.client.shard.ids[0] == this.client.shard.count - 1) {
			...
			this.client.log(chalk.magenta.underline.bold(`Bot is online: ${this.client.shard.count} shards, ${totalGuilds} servers and ${totalMembers} members.`));

			if (this.client.user.id == '153742397208002560') {
